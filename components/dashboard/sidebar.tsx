...
const navGroups: NavGroup[] = [
  ...
  },
  {
    label: "Sales",
    items: [
      { id: "sales-one-time", label: "One-Time", icon: FileBadge },
      { id: "sales-subscriptions", label: "Subscriptions", icon: RefreshCw },
      { id: "sales-usage", label: "Usage Events", icon: Activity },
      { id: "sales-credits", label: "Token Credits", icon: Coins },
      { id: "sales-licenses", label: "Licenses", icon: KeyRound },
    ],
  },
  {
    label: "Management",

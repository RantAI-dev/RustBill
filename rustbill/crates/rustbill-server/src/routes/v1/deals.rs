...
const LEGACY_LINK_HEADER: &str = "</api/v1/billing/subscriptions>; rel=\"successor-version\", </api/v1/billing/usage>; rel=\"successor-version\", </api/v1/billing/invoices>; rel=\"successor-version\"";
